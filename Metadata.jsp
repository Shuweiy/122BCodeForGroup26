            ...
            <div class="row">
                <div class="col-lg-12">
                                    ...
                                    DriverManager.getConnection("jdbc:mysql://localhost:3306/moviedb", "root",
                                     ...
                                     "");
                                    Statement action1 = connection.createStatement();
                                    Statement action2 = connection.createStatement();
                                    Statement action3 = connection.createStatement();

                                    int count = 0;
                                  ResultSet result = action1.executeQuery("show tables;");
                                  while(result.next())
                                  {
                                    count += 1;
                                    ...
                                    for (int i = 1; i <= metadata.getColumnCount(); i++)
                                    {
                                      ...
                                      out.write("<th>" + metadata.getColumnTypeName(i)+"</th>");
                                      out.write("</tr>");
                                      out.write("</thead>");
                                    }
                                    out.write("</tbody>");
